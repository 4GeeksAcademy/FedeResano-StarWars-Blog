        ...
        <div className="grid-container">
            {store.starships.map((element) => (
                <div className="card" key={element.uid}>
                    <img src={`https://starwars-visualguide.com/assets/img/starships/${element.uid}.jpg`} className="card-img-top" alt={element.properties.name} />
                    ...
                    <div className="d-flex justify-content-center">
                        <Link to={`/starships/${element.uid}`}> Learn more</Link>
